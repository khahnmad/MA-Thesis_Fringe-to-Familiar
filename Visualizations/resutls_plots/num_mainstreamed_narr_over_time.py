...
x_y_97_20 = get_data(dir_narr_97_20)
x_y_97_30 = get_data(dir_narr_97_30)
x_y_98_20 = get_data(dir_narr_98_20)
x_y_98_30 = get_data(dir_narr_98_30)
...
plt.ylabel('Number of Directly Mainstreamed Narratives')
plt.title('Number of Directly Mainstreamed Narratives over time ')
plt.show()